...
class Config:
    ...
    # If the “Remember Me” cookie should cross domains, set the domain value here (i.e. .example.com would allow the cookie to be used on all subdomains of example.com). Default: None
    REMEMBER_COOKIE_DOMAIN = None
    # Limits the “Remember Me” cookie to a certain path. Default: /
    REMEMBER_COOKIE_PATH = '/'
    # Restricts the “Remember Me” cookie’s scope to secure channels (typically HTTPS). Default: False
    REMEMBER_COOKIE_SECURE = False
    # Prevents the “Remember Me” cookie from being accessed by client-side scripts. Default: True
    ...
    # Restricts the “Remember Me” cookie to first-party or same-site context. Default: None
