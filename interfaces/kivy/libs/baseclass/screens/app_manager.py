...
from interfaces.kivy.libs.baseclass.screens.main_screen import MainScreen
from interfaces.kivy.libs.baseclass.screens.transaction_editor_screen import TransactionEditorScreen
